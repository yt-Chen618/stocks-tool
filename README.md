...
1. Monitor the filled paper covered-call proposal `35f8f82e-f877-4cd2-8cc4-0faeb80d58a7`; lifecycle reconciliation filled order `14c4fb5f-06b3-48fd-8ac3-150ab35cdb1b` for `1` `QQQ260626C764000.US` at `6.7800`, and the latest monitor at `2026-06-02T14:47:55Z` returned `hold` with estimated open P/L `-89.00`.
2. Keep using the covered-call activity lifecycle view for any future close / roll order ids; stale working orders now surface age, stale flag, and suggested manual intervention before any cancel / replace action.
